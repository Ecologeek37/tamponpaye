...
/**
 * \file    test/phpunit/TamponpayeFunctionalTest.php
 * \ingroup tamponpaye
...
/**
 * Class TamponpayeFunctionalTest
 *
 ...
 *
 * @package Testtamponpaye
 */
class TamponpayeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modTamponpaye')->click();
		} else {
			// Disable the module
			$this->byHref('modTamponpaye')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/tamponpaye/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('tamponpaye/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/tamponpaye/admin/about.php');
		$this->authenticate();
		return $this->assertContains('tamponpaye/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('tamponpayewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modTamponpaye_TamponpayeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modTamponpaye_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
